        ...
        if iteration % 50 == 0:
            ...
            with torch.no_grad():
                if args_dict['own_data']:
                    rot_error, trans_error, sim3 = 0.0, 0.0, None
                else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dust3r_path", type=str, default="./duster/checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth", help="Path to dust3r model checkpoint")
